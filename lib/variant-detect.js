...
const TAG_RULES = [
  ...
  // Neck / format / build (useful “form” tags)
  ["counterbalance", [RE("\\bcounter\\s*balance|\\bcb\\b(?![a-z])")]],
...
// If the raw title strongly indicates a child line, we can push a synthetic tag.
// These are *not* used in equality matching, just clustering & chips labelling.
